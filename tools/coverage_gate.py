...
FLOORS: dict[str, float] = {
    ...
    # glue and reporting branches do not warrant tests solely for 100%.
    "examples/gabriels_workflow/config.py": 90.0,
    "examples/gabriels_workflow/development_workflow.py": 90.0,
